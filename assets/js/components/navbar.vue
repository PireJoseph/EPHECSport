<template>
    <div>
        ...
        <div id="navDemo" v-bind:class="{ 'w3-show': mobileMenuShowed }" v-on:click="toggleNavMenu" class="w3-bar-block w3-theme-d2 w3-hide w3-hide-large w3-hide-medium w3-large">
